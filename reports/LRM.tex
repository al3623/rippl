...
In the cases above, only the first element of the list is evaluated. This means that although the second element of \texttt{funky\_list} will have an error from dividing by 0, the code above will run error free. An error will becoming apparent upon evaluating the second element of the list. \\
