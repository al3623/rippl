...
ranged list \\
With ranged lists, we can create a list without specifying every element. Ranges will always have an interval of + 1, and ranges are only allowed for integer lists. 
...
\begin{lstlisting}[language=rippl]
[x - y - z | x over [10, 1], y over [2, 3], z over [1, 5]] # [-7, 7]

[x + y | x over [10, 30, 50], y over [10...12], if x != y] # [41, 62]
\end{lstlisting}
